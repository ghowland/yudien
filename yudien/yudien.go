...
func InitUdn() {
	...
	UdnFunctions = map[string]UdnFunc{
		...
		"__array_map_filter_match":  UDN_ArrayMapFilterMatch, // Returns all maps in an array, compares two arrays, and returns an array of all the matches between the 2 list.  Default is "any".  Options will be expanded to get more functionality when needed (need use case).
